...
public class MyServer implements HttpHandler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("测试访问:http://localhost:9527" + REQ_CONTEXT + "/wallpaper/wp003.jpg");
        System.out.println("测试访问:http://localhost:9527" + REQ_CONTEXT + "/showhtml/svgdesktop.html?wp003.jpg");
        System.out.println("测试访问:http://localhost:9527" + REQ_CONTEXT + "/list");
    }
